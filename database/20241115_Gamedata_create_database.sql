...
CREATE TABLE IF NOT EXISTS `gamedata`.`user` (
  ...
  `game_admin` TINYINT NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `gamedata`.`group_objective` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_group_objective_game_mission1_idx` (`game_mission_id` ASC) VISIBLE,
  INDEX `fk_group_objective_scale1_idx` (`scale_id` ASC) VISIBLE,
  CONSTRAINT `fk_group_objective_game_mission1`
...
CREATE TABLE IF NOT EXISTS `gamedata`.`player_objective` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_player_objective_game_mission1_idx` (`game_mission_id` ASC) VISIBLE,
  INDEX `fk_player_objective_scale1_idx` (`scale_id` ASC) VISIBLE,
  CONSTRAINT `fk_player_objective_game_mission1`
    FOREIGN KEY (`game_mission_id`)
    REFERENCES `gamedata`.`game_mission` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `gamedata`.`mission_action`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`mission_action` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `gamedata`.`player_action`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`player_action` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(45) NOT NULL,
  `key` VARCHAR(45) NOT NULL,
  `value` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `gamedata`.`group_action`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`group_action` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(45) NOT NULL,
  `key` VARCHAR(45) NOT NULL,
  `value` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `gamedata`.`organization_token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`organization_token` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gamedata`.`session_role` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_session_role_organization1_idx` (`organization_id` ASC) VISIBLE,
  INDEX `fk_session_role_game_session1_idx` (`game_session_id` ASC) VISIBLE,
  CONSTRAINT `fk_session_role_organization1`
    FOREIGN KEY (`organization_id`)
    REFERENCES `gamedata`.`organization` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
