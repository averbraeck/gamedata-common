...
CREATE TABLE IF NOT EXISTS `gamedata`.`game_access` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_game_access_game1_idx` (`game_id` ASC) VISIBLE,
  INDEX `fk_game_access_organization1_idx` (`organization_id` ASC) VISIBLE,
  CONSTRAINT `fk_game_access_game1`
    FOREIGN KEY (`game_id`)
    REFERENCES `gamedata`.`game` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_game_access_organization1`
...
CREATE TABLE IF NOT EXISTS `gamedata`.`dashboard_template` (
  ...
  CONSTRAINT `fk_private_dashboard_game_mission1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_private_dashboard_game_access1`
    FOREIGN KEY (`game_access_id`)
    REFERENCES `gamedata`.`game_access` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `gamedata`.`access_token` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_access_token_game_access1_idx` (`game_access_id` ASC) VISIBLE,
  UNIQUE INDEX `value_UNIQUE` (`value` ASC) VISIBLE,
  CONSTRAINT `fk_access_token_game_access1`
    FOREIGN KEY (`game_access_id`)
    REFERENCES `gamedata`.`game_access` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gamedata`.`game_access_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`game_access_role` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `view` TINYINT NOT NULL DEFAULT 0,
  `edit` TINYINT NOT NULL DEFAULT 0,
  `user_id` INT UNSIGNED NOT NULL,
  ...
  INDEX `fk_game_access_role_game_access1_idx` (`game_access_id` ASC) VISIBLE,
  CONSTRAINT `fk_user_role_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `gamedata`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_game_access_role_game_access1`
    FOREIGN KEY (`game_access_id`)
    REFERENCES `gamedata`.`game_access` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
