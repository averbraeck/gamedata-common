...
CREATE TABLE IF NOT EXISTS `gamedata`.`user` (
  ...
  `game_admin` TINYINT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `gamedata`.`game_role` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_game_role_user_idx` (`user_id` ASC) VISIBLE,
  INDEX `fk_game_role_game1_idx` (`game_id` ASC) VISIBLE,
  CONSTRAINT `fk_game_role_user`
    FOREIGN KEY (`user_id`)
...
CREATE TABLE IF NOT EXISTS `gamedata`.`game_session` (
  ...
  `token_forced` TINYINT NOT NULL DEFAULT 1,
  ...
  INDEX `fk_game_session_organization1_idx` (`organization_id` ASC) VISIBLE,
  CONSTRAINT `fk_game_session_game_version1`
    FOREIGN KEY (`game_version_id`)
    REFERENCES `gamedata`.`game_version` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_game_session_organization1`
...
-- -----------------------------------------------------
-- Table `gamedata`.`dashboard_layout`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`dashboard_layout` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `code` VARCHAR(16) NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `description` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `gamedata`.`organization_game`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`organization_game` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `token_forced` TINYINT NOT NULL DEFAULT 0,
...
-- -----------------------------------------------------
-- Table `gamedata`.`dashboard_template`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`dashboard_template` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `code` VARCHAR(16) NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `description` TEXT NOT NULL,
  ...
  `game_version_id` INT UNSIGNED NOT NULL,
  `game_mission_id` INT UNSIGNED NULL,
  `organization_game_id` INT UNSIGNED NULL,
  `dashboard_layout_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_private_dashboard_game_mission1_idx` (`game_mission_id` ASC) VISIBLE,
  INDEX `fk_dashboard_template_game_version1_idx` (`game_version_id` ASC) VISIBLE,
  INDEX `fk_dashboard_template_dashboard_layout1_idx` (`dashboard_layout_id` ASC) VISIBLE,
  INDEX `fk_dashboard_template_organization_game1_idx` (`organization_game_id` ASC) VISIBLE,
  CONSTRAINT `fk_private_dashboard_game_mission1`
    FOREIGN KEY (`game_mission_id`)
    REFERENCES `gamedata`.`game_mission` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_dashboard_template_game_version1`
    FOREIGN KEY (`game_version_id`)
    REFERENCES `gamedata`.`game_version` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_dashboard_template_dashboard_layout1`
    FOREIGN KEY (`dashboard_layout_id`)
    REFERENCES `gamedata`.`dashboard_layout` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_dashboard_template_organization_game1`
    FOREIGN KEY (`organization_game_id`)
    REFERENCES `gamedata`.`organization_game` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `gamedata`.`group_role` (
  ...
  INDEX `fk_group_role_player1_idx` (`player_id` ASC) VISIBLE,
  CONSTRAINT `fk_group_role_group1`
    FOREIGN KEY (`group_id`)
    REFERENCES `gamedata`.`group` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_group_role_player1`
    FOREIGN KEY (`player_id`)
    REFERENCES `gamedata`.`player` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gamedata`.`organization_game_token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`organization_game_token` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  ...
  INDEX `fk_organization_game_token_organization_game1_idx` (`organization_game_id` ASC) VISIBLE,
  CONSTRAINT `fk_organization_game_token_organization_game1`
    FOREIGN KEY (`organization_game_id`)
    REFERENCES `gamedata`.`organization_game` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gamedata`.`organization_game_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`organization_game_role` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `view` TINYINT NOT NULL DEFAULT 0,
  `edit` TINYINT NOT NULL DEFAULT 0,
  `user_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `gamedata`.`game_session_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`game_session_role` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `view` TINYINT NOT NULL DEFAULT 0,
  `edit` TINYINT NOT NULL DEFAULT 0,
  `user_id` INT UNSIGNED NOT NULL,
  ...
  INDEX `fk_game_session_role_user1_idx` (`user_id` ASC) VISIBLE,
  CONSTRAINT `fk_game_session_role_game_session1`
    FOREIGN KEY (`game_session_id`)
    REFERENCES `gamedata`.`game_session` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_game_session_role_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `gamedata`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gamedata`.`dashboard_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`dashboard_role` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `view` TINYINT NOT NULL DEFAULT 0,
  `edit` TINYINT NOT NULL DEFAULT 0,
  `user_id` INT UNSIGNED NOT NULL,
  `dashboard_template_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_dashboard_role_dashboard_template1_idx` (`dashboard_template_id` ASC) VISIBLE,
  INDEX `fk_dashboard_role_user1_idx` (`user_id` ASC) VISIBLE,
  CONSTRAINT `fk_dashboard_role_dashboard_template1`
    FOREIGN KEY (`dashboard_template_id`)
    REFERENCES `gamedata`.`dashboard_template` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_dashboard_role_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `gamedata`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gamedata`.`dashboard`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`dashboard` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `description` TEXT NOT NULL,
  `query` TEXT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_dashboard_dashboard_template1_idx` (`dashboard_template_id` ASC) VISIBLE,
  CONSTRAINT `fk_dashboard_dashboard_template1`
    FOREIGN KEY (`dashboard_template_id`)
    REFERENCES `gamedata`.`dashboard_template` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gamedata`.`dashboard_token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`dashboard_token` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `key` VARCHAR(45) NOT NULL,
  `value` VARCHAR(255) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_dashboard_token_dashboard1_idx` (`dashboard_id` ASC) VISIBLE,
  CONSTRAINT `fk_dashboard_token_dashboard1`
    FOREIGN KEY (`dashboard_id`)
    REFERENCES `gamedata`.`dashboard` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gamedata`.`dashboard_session`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`dashboard_session` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `dashboard_id` INT UNSIGNED NOT NULL,
  `game_session_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_dashboard_session_dashboard1_idx` (`dashboard_id` ASC) VISIBLE,
  INDEX `fk_dashboard_session_game_session1_idx` (`game_session_id` ASC) VISIBLE,
  CONSTRAINT `fk_dashboard_session_dashboard1`
    FOREIGN KEY (`dashboard_id`)
    REFERENCES `gamedata`.`dashboard` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_dashboard_session_game_session1`
    FOREIGN KEY (`game_session_id`)
    REFERENCES `gamedata`.`game_session` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gamedata`.`dashboard_element`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`dashboard_element` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `code` VARCHAR(16) NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `description` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `gamedata`.`element_property`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`element_property` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `code` VARCHAR(16) NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `description` TEXT NOT NULL,
  `type` VARCHAR(45) NOT NULL,
  `dashboard_element_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_element_property_dashboard_element1_idx` (`dashboard_element_id` ASC) VISIBLE,
  UNIQUE INDEX `code_UNIQUE` (`code` ASC) VISIBLE,
  CONSTRAINT `fk_element_property_dashboard_element1`
    FOREIGN KEY (`dashboard_element_id`)
    REFERENCES `gamedata`.`dashboard_element` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gamedata`.`template_element`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`template_element` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `dashboard_element_id` INT UNSIGNED NOT NULL,
  `dashboard_template_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_template_element_dashboard_element1_idx` (`dashboard_element_id` ASC) VISIBLE,
  INDEX `fk_template_element_dashboard_template1_idx` (`dashboard_template_id` ASC) VISIBLE,
  CONSTRAINT `fk_template_element_dashboard_element1`
    FOREIGN KEY (`dashboard_element_id`)
    REFERENCES `gamedata`.`dashboard_element` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_template_element_dashboard_template1`
    FOREIGN KEY (`dashboard_template_id`)
    REFERENCES `gamedata`.`dashboard_template` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `gamedata`.`property_value`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`property_value` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `value` TEXT NOT NULL,
  `element_property_id` INT UNSIGNED NOT NULL,
  `template_element_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_property_value_element_property1_idx` (`element_property_id` ASC) VISIBLE,
  INDEX `fk_property_value_template_element1_idx` (`template_element_id` ASC) VISIBLE,
  CONSTRAINT `fk_property_value_element_property1`
    FOREIGN KEY (`element_property_id`)
    REFERENCES `gamedata`.`element_property` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_property_value_template_element1`
    FOREIGN KEY (`template_element_id`)
    REFERENCES `gamedata`.`template_element` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gamedata`.`error`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`error` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `timestamp` DATETIME NOT NULL,
  `error_type` VARCHAR(16) NOT NULL,
  `record_stored` TINYINT NOT NULL DEFAULT 0,
  `message` VARCHAR(255) NOT NULL,
  `content` TEXT NOT NULL,
  `data_type` VARCHAR(45) NULL,
  `session_token` VARCHAR(45) NULL,
  `game_session_code` VARCHAR(45) NULL,
  `game_version_code` VARCHAR(45) NULL,
  `organization_code` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE)
ENGINE = InnoDB;
