...
CREATE TABLE IF NOT EXISTS `gamedata`.`session_role` (
  ...
  INDEX `fk_session_role_organization_role1_idx` (`organization_role_id` ASC) VISIBLE,
  CONSTRAINT `fk_session_role_game_session1`
    FOREIGN KEY (`game_session_id`)
    REFERENCES `gamedata`.`game_session` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_session_role_organization_role1`
    FOREIGN KEY (`organization_role_id`)
    REFERENCES `gamedata`.`organization_role` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gamedata`.`org_game_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gamedata`.`org_game_role` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `session_admin` TINYINT NOT NULL DEFAULT 0,
  `session_viewer` TINYINT NOT NULL DEFAULT 0,
  `game_access_id` INT UNSIGNED NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_org_game_role_organization_role1_idx` (`organization_role_id` ASC) VISIBLE,
  INDEX `fk_org_game_role_game_access1_idx` (`game_access_id` ASC) VISIBLE,
  CONSTRAINT `fk_org_game_role_organization_role1`
    FOREIGN KEY (`organization_role_id`)
    REFERENCES `gamedata`.`organization_role` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_org_game_role_game_access1`
    FOREIGN KEY (`game_access_id`)
    REFERENCES `gamedata`.`game_access` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
