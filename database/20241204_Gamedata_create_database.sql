...
CREATE TABLE IF NOT EXISTS `gamedata`.`public_dashboard` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_public_dashboard_game_mission1_idx` (`game_mission_id` ASC) VISIBLE,
  CONSTRAINT `fk_public_dashboard_game_mission1`
    FOREIGN KEY (`game_mission_id`)
    REFERENCES `gamedata`.`game_mission` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `gamedata`.`user_role` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_user_role_user1_idx` (`user_id` ASC) INVISIBLE,
  INDEX `fk_user_role_organization1_idx` (`organization_id` ASC) VISIBLE,
  INDEX `fk_user_role_game_access1_idx` (`session_game_access_id` ASC) VISIBLE,
  INDEX `fk_user_role_game_session1_idx` (`session_game_session_id` ASC) VISIBLE,
  CONSTRAINT `fk_user_role_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `gamedata`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_role_organization1`
    FOREIGN KEY (`organization_id`)
    REFERENCES `gamedata`.`organization` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_role_game_access1`
    FOREIGN KEY (`session_game_access_id`)
    REFERENCES `gamedata`.`game_access` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_role_game_session1`
