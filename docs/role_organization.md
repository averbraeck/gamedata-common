...
| `game_session` | CREATE | Create, edit and delete `game_session` records for existing `organization_game` records. |
| `game_session_role` | CREATE | Create, edit and delete `game_session_role` records between existing and accessible `organization_game` records |
...
| `organization_game`  | EDIT | Fields `name`, `token_forced`, and `anonymous_sessions` of **existing** `organization_game` records. |
| `organization_game_role` | CREATE | Create, edit and delete `organization_game_role` records for existing `organization_game` records. |
...
records and existing and users. |
...
| `game_session` | CREATE | Create, edit and delete `game_session` records for existing `organization_game` records. |
| `game_session_role` | NONE | The organization editor does not have access to users or roles. |
...
| `game_session` | VIEW | View `game_session` records for existing `organization_game` records. |
