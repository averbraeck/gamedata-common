...
| ----- | ------ | ----------- |
| `access_token` | NONE | A game admin does not have access to `access_token` records. |
...
| `dashboard_template` | NONE | A game admin does not have access to `dashboard_template` records that have a relation to existing `game_access` records for an `organization`. |
|   | CREATE | A game admin can create, edit and view `dashboard_template` records that do not have a relation to existing `game_access` records for an `organization`, but that do refer to games to which the `game_admin` has edit access. |
...
| `game_access`  | NONE | A game admin does not have access to `game_access` records. |
| `game_access_role` | NONE | A game admin does not have access to `game_access_role` records. |
...
| `session_role` | NONE | A game admin does not have access to `session_role` records. |
...
| Table | Access | Explanation |
| ----- | ------ | ----------- |
| `access_token` | NONE | A game editor does not have access to `access_token` records. |
...
| `dashboard_template` | NONE | A game editor does not have access to `dashboard_template` records that have a relation to existing `game_access` records for an `organization`. |
|   | CREATE | A game editor can create, edit and view `dashboard_template` records that do not have a relation to existing `game_access` records for an `organization`, but that do refer to games to which the `game_editor` has edit access. |
...
| `game_access`  | NONE | A game editor does not have access to `game_access` records. |
| `game_access_role` | NONE | A game editor does not have access to `game_access_role` records. |
...
| `session_role` | NONE | A game editor does not have access to `session_role` records. |
| `template_element` | CREATE | Create, edit and delete `template_element` records for `dashboard_template` records to which the user has CREATE access. |
...
| `dashboard_session` | NONE | A game editor does not have access to `dashboard_session` records. |
| `dashboard_template` | NONE | A game editor does not have access to `dashboard_template` records that have a relation to existing `game_access` records for an `organization`. |
|   | VIEW | A game editor can create, edit and view `dashboard_template` records that do not have a relation to existing `game_access` records for an `organization`, but that do refer to games to which the `game_editor` has edit access. |
