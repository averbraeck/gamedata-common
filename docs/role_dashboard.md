...
| `element_property` | VIEW | All dashboard editors can view all the existing element properties (these are defined with backend code changes). |
...
| `game_session_role` | NONE | The dashboard editor does not have access to users or roles. |
