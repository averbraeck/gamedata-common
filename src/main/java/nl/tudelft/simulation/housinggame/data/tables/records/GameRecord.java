...
public class GameRecord extends UpdatableRecordImpl<GameRecord> implements Record4<Integer, String, String, String> {
    ...
    /**
     * Setter for <code>gamedata.game.version</code>.
     */
    ...
    /**
     * Getter for <code>gamedata.game.version</code>.
     */
    ...
    @Override
    public GameRecord values(Integer value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GameRecord(Integer id, String name, String description, String version) {
        super(Game.GAME);
