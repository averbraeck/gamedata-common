...
public class PlayerScoreRecord extends UpdatableRecordImpl<PlayerScoreRecord> implements Record13<Integer, String, Double, Double, LocalDateTime, Integer, Byte, String, String, String, String, Integer, Integer> {
    ...
    @Override
    public PlayerScoreRecord values(Integer value1, String value2, Double value3, Double value4, LocalDateTime value5, Integer value6, Byte value7, String value8, String value9, String value10, String value11, Integer value12, Integer value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PlayerScoreRecord(Integer id, String scoreType, Double delta, Double newScore, LocalDateTime timestamp, Integer missionAttempt, Byte finalScore, String status, String round, String gameTime, String groupingCode, Integer playerAttemptId, Integer playerObjectiveId) {
        super(PlayerScore.PLAYER_SCORE);
