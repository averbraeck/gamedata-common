...
public class OrganizationRecord extends UpdatableRecordImpl<OrganizationRecord> implements Record4<Integer, String, String, Byte> {
    ...
    /**
     * Setter for <code>gamedata.organization.anonymous_sessions</code>.
     */
    ...
    /**
     * Getter for <code>gamedata.organization.anonymous_sessions</code>.
     */
    ...
    public Field<Byte> field4() {
        return Organization.ORGANIZATION.ANONYMOUS_SESSIONS;
    }
     ...
     */
    public OrganizationRecord(Integer id, String code, String name, Byte anonymousSessions) {
        super(Organization.ORGANIZATION);
