...
public class GameSessionRecord extends UpdatableRecordImpl<GameSessionRecord> implements Record12<Integer, String, String, String, String, LocalDate, Byte, LocalDateTime, LocalDateTime, Integer, Integer, Byte> {
    ...
    @Override
    public Row12<Integer, String, String, String, String, LocalDate, Byte, LocalDateTime, LocalDateTime, Integer, Integer, Byte> valuesRow() {
    ...
    @Override
    public GameSessionRecord value10(Integer value) {
        setGameVersionId(value);
        return this;
    }

    @Override
    public GameSessionRecord value11(Integer value) {
    ...
    @Override
    public GameSessionRecord values(Integer value1, String value2, String value3, String value4, String value5, LocalDate value6, Byte value7, LocalDateTime value8, LocalDateTime value9, Integer value10, Integer value11, Byte value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GameSessionRecord(Integer id, String code, String name, String sessionToken, String sessionStatus, LocalDate playDate, Byte valid, LocalDateTime validFrom, LocalDateTime validUntil, Integer gameVersionId, Integer organizationId, Byte tokenForDashboard) {
        super(GameSession.GAME_SESSION);
