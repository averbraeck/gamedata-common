...
public class LearningGoalRecord extends UpdatableRecordImpl<LearningGoalRecord> implements Record4<Integer, String, String, Integer> {
    ...
    @Override
    public LearningGoalRecord value4(Integer value) {
        setGameMissionId(value);
        return this;
    }

    @Override
    public LearningGoalRecord values(Integer value1, String value2, String value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LearningGoalRecord(Integer id, String name, String description, Integer gameMissionId) {
        super(LearningGoal.LEARNING_GOAL);
