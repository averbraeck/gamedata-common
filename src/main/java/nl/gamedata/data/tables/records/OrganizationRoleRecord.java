...
public class OrganizationRoleRecord extends UpdatableRecordImpl<OrganizationRoleRecord> implements Record5<Integer, Byte, Byte, Integer, Integer> {
    ...
    /**
     * Setter for <code>gamedata.organization_role.member</code>.
     */
    ...
    /**
     * Getter for <code>gamedata.organization_role.member</code>.
     */
    ...
    public Field<Byte> field2() {
        return OrganizationRole.ORGANIZATION_ROLE.MEMBER;
    }
    ...
    @Override
    public OrganizationRoleRecord values(Integer value1, Byte value2, Byte value3, Integer value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrganizationRoleRecord(Integer id, Byte member, Byte admin, Integer userId, Integer organizationId) {
        super(OrganizationRole.ORGANIZATION_ROLE);
