...
public class ScaleRecord extends UpdatableRecordImpl<ScaleRecord> implements Record7<Integer, String, Double, Double, String, String, Integer> {
    ...
    @Override
    public Row7<Integer, String, Double, Double, String, String, Integer> valuesRow() {
    ...
    @Override
    public ScaleRecord value7(Integer value) {
        setGameId(value);
        return this;
    }

    @Override
    public ScaleRecord values(Integer value1, String value2, Double value3, Double value4, String value5, String value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
