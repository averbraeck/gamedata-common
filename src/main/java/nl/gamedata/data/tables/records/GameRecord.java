...
public class GameRecord extends UpdatableRecordImpl<GameRecord> implements Record6<Integer, String, String, String, Byte, String> {
    ...
    @Override
    public GameRecord values(Integer value1, String value2, String value3, String value4, Byte value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GameRecord(Integer id, String code, String name, String description, Byte tokenForced, String logo) {
        super(Game.GAME);
