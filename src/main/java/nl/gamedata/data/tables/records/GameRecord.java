...
public class GameRecord extends UpdatableRecordImpl<GameRecord> implements Record7<Integer, String, String, String, Byte, Byte, byte[]> {
    ...
    @Override
    public Row7<Integer, String, String, String, Byte, Byte, byte[]> valuesRow() {
    ...
    @Override
    public GameRecord value7(byte[] value) {
        setLogo(value);
        return this;
    }

    @Override
    public GameRecord values(Integer value1, String value2, String value3, String value4, Byte value5, Byte value6, byte[] value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
