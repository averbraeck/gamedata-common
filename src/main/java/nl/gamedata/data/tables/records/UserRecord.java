...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record8<Integer, String, String, String, String, Integer, Byte, Byte> {
    ...
    @Override
    public Row8<Integer, String, String, String, String, Integer, Byte, Byte> valuesRow() {
    ...
    @Override
    public UserRecord values(Integer value1, String value2, String value3, String value4, String value5, Integer value6, Byte value7, Byte value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(Integer id, String name, String email, String password, String salt, Integer organizationId, Byte superAdmin, Byte orgAdmin) {
        super(User.USER);
