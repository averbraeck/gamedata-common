...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record8<Integer, String, String, Integer, Integer, Byte, Byte, Byte> {
    ...
    @Override
    public Row8<Integer, String, String, Integer, Integer, Byte, Byte, Byte> valuesRow() {
    ...
    @Override
    public UserRecord values(Integer value1, String value2, String value3, Integer value4, Integer value5, Byte value6, Byte value7, Byte value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(Integer id, String name, String password, Integer organizationId, Integer roleId, Byte superAdmin, Byte orgAdmin, Byte gameAdmin) {
        super(User.USER);
