...
public class Keys {
    ...
    public static final ForeignKey<GroupEventRecord, GroupRecord> FK_GROUPLOGDATA_GROUP1 = Internal.createForeignKey(GroupEvent.GROUP_EVENT, DSL.name("fk_grouplogdata_group1"), new TableField[] { GroupEvent.GROUP_EVENT.GROUP_ID }, Keys.KEY_GROUP_PRIMARY, new TableField[] { Group.GROUP.ID }, true);
