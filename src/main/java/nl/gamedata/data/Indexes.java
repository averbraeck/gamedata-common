...
public class Indexes {
    ...
    public static final Index GROUP_ACTION_FK_GROUPLOGDATA_GROUP1_IDX = Internal.createIndex(DSL.name("fk_grouplogdata_group1_idx"), GroupAction.GROUP_ACTION, new OrderField[] { GroupAction.GROUP_ACTION.GROUP_ID }, false);
    ...
    public static final Index PLAYER_ACTION_FK_PLAYER_LOGDATA_PLAYER_ATTEMPT1_IDX = Internal.createIndex(DSL.name("fk_player_logdata_player_attempt1_idx"), PlayerAction.PLAYER_ACTION, new OrderField[] { PlayerAction.PLAYER_ACTION.PLAYER_ATTEMPT_ID }, false);
    ...
    public static final Index SESSION_ROLE_FK_SESSION_ROLE_ORGANIZATION1_IDX = Internal.createIndex(DSL.name("fk_session_role_organization1_idx"), SessionRole.SESSION_ROLE, new OrderField[] { SessionRole.SESSION_ROLE.ORGANIZATION_ID }, false);
    ...
    public static final Index MISSION_ACTION_FK_SESSIONLOGDATA_GAMESESSION1_IDX = Internal.createIndex(DSL.name("fk_sessionlogdata_gamesession1_idx"), MissionAction.MISSION_ACTION, new OrderField[] { MissionAction.MISSION_ACTION.GAMESESSION_ID }, false);
    public static final Index ORGANIZATION_TOKEN_FK_TOKEN_GAME1_IDX = Internal.createIndex(DSL.name("fk_token_game1_idx"), OrganizationToken.ORGANIZATION_TOKEN, new OrderField[] { OrganizationToken.ORGANIZATION_TOKEN.GAME_ID }, false);
    public static final Index ORGANIZATION_TOKEN_FK_TOKEN_ORGANIZATION1_IDX = Internal.createIndex(DSL.name("fk_token_organization1_idx"), OrganizationToken.ORGANIZATION_TOKEN, new OrderField[] { OrganizationToken.ORGANIZATION_TOKEN.ORGANIZATION_ID }, false);
